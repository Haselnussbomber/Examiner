...
function ex:UpdateObjects()
	...
	if (UnitIsVisible(ex.unit)) then
		...
		ex.portrait:SetTexture("Interface\\CharacterFrame\\TemporaryPortrait-"..(info.sex == 3 and "Female" or "Male").."-"..(info.raceFixed or ""));	-- Az: WoD: raceFixed has a risk of being nil
		ex.model:ClearModel();
		ex.model.cleared = 1;
	end
